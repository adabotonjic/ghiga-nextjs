"use strict";(()=>{var e={};e.id=290,e.ids=[290],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},31:(e,l,a)=>{a.r(l),a.d(l,{config:()=>$,default:()=>c,routeModule:()=>p});var t={};a.r(t),a.d(t,{default:()=>handler});var o=a(1802),s=a(7153),r=a(6249);let i="https://www.ghirardellinicola.it",n=new Date,u=n.toJSON(),d=[{name:"servizi"},{name:"privacy-policy"},{name:"cookie-policy"},{name:"contatti"}],m=[{slug:"conversioni-serrature-porte-blindate"},{slug:"fornitura-e-installazione-zanzariere"},{slug:"riparazioni-e-sostituzioni-basculanti-e-sezionali"},{slug:"sostituzioni-serrature-di-tutti-i-tipi"}];function handler(e,l){l.statusCode=200,l.setHeader("Content-Type","text/xml"),l.setHeader("Cache-control","stale-while-revalidate, s-maxage=3600");let a=`<?xml version="1.0" encoding="UTF-8"?>

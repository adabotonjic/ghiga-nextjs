        ...
        style={{borderBottom:'1px solid', borderBottomColor: 'rgba(0,0,0,.1)'}}>
            <div className="container">
                ...
                <div className="row align-items-center">
                    ...
                    <figure className="mb-3 mb-xl-4  figure">
                        <img width="100%" height="100%" alt='Chi sono' src='../images/chi-sono.webp' loading="lazy" className="mx-auto w-100 mb-0 figure-img img-fluid" />
                    </figure>
                    </div>
                </div>
            </div>
